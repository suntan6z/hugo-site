    ...
    <div class="container">
      <div class="contact-grid">
        <div class="contact-form fade-up">
          <h2 id="form-title">Invia un messaggio</h2>
          <p class="form-note" id="form-note">I campi contrassegnati con <span style="color:var(--primary)">*</span> sono obbligatori.</p>
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <div class="phone-field">
                  <select id="phone-country" name="phoneCountry" aria-label="Prefisso internazionale">
