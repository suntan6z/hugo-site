...
<style>
	...
	.new { background: var(--accent); color: var(--accent-ink); padding: 0.45rem 0.85rem; border: 0; border-radius: 8px; font-size: 0.88rem; font-weight: 600; cursor: pointer; }
	...
	.add { display: grid; grid-template-columns: 2fr 0.6fr 1.2fr auto; gap: 0.6rem; align-items: end;
		background: var(--panel); border: 1px solid var(--line); border-radius: var(--radius); padding: 1rem; margin-bottom: 1.25rem; }
	.add label { font-size: 0.8rem; color: var(--muted); }
	.add input { display: block; width: 100%; margin-top: 0.25rem; padding: 0.5rem 0.6rem; border: 1px solid var(--line); border-radius: 8px; background: var(--bg); }
	.add button { padding: 0.55rem 1rem; border: 0; border-radius: 8px; background: var(--accent); color: var(--accent-ink); font-weight: 600; cursor: pointer; }
	.add .note { grid-column: 1 / -1; font-size: 0.78rem; color: var(--muted); margin: 0; }
	...
	.cities li { display: flex; justify-content: space-between; align-items: center; padding: 0.7rem 0; border-bottom: 1px solid var(--line); }
